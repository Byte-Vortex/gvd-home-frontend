        ...
        <section className="space-y-8">
            ...
            <div className='space-y-2'>
                ...
                <div className='flex w-full justify-between gap-2'>
                    ...
                    <SwiperPrevNavigationButton className="ml-auto flex bg-on-surface text-surface text-3xl h-max px-4 py-1 w-auto border" ref={sliderRef} >
                        <LeftIcon />
                    </SwiperPrevNavigationButton>

                    <SwiperNextNavigationButton className="flex bg-on-surface text-surface text-3xl h-max px-4 py-1 w-auto border" ref={sliderRef} >
                        <RightIcon />
            ...
            >
                ...
                {
                    data.destinations?.map((cardData, index) => (
